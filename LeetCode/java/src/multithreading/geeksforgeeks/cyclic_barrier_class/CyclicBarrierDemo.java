package multithreading.geeksforgeeks.cyclic_barrier_class;
...
class Tester implements Runnable
{
    ...
    public static CyclicBarrier newBarrier = new CyclicBarrier(NUM_THREADS);
    // int barrier.getParties();
    // int barrier.getNumberWaiting();
    // boolean barrier.isBroken();
    // in child threads & main thread: barrier.await();
    // in main thread: barrier.reset();
